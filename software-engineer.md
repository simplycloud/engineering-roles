...
| :------- | :-------: | :-------: | :-------: |
| **Coding Fluency** | With solid CS fundamentals, is able to use code to build a functional product within a reasonable amount of time. Can actively take on small and medium-sized projects that add to existing features and components. Is proficient with at least one programming language. | With strong CS fundamentals, is able to use code to build functional products from scratch in a reasonable amount of time. Effective with both frontend and backend programming languages. Provides exemplary use of algorithms, data structures, and more advanced concepts. | Expert CS fundamentals across multiple programming languages and technologies. Actively mentors and teaches others across the both in pair programming models and through code review feedback. Often experiments with ways to improve the performance of algorithms, reduce the lines of code in the codebase, or increase the efficiency and sustainability of the codebase. |
| **Coding Quality** | Code correctly solves the problem in a minimal way, is written in a way that is reasonably understood, and follows norms of existing codebase. Feedback provided throughout the review process is quickly accepted and adopted. | Code solves the problem with in an effective and efficient manner, is well tested, free of errors, and is easy to follow for those new to the codebase. Code reviews generally have minimal feedback. Is active in helping others improve and raise the bar of the team’s code. | Code written is exemplary due to efficiency, simplicity, and use of best practices. Code is well-tested and documented. Actively participates in helping others to understand, meet, and eventually raise the bar in coding quality across the entire org. |
| **Communication** | Able to communicate ideas clearly. Asks questions to remove ambiguity. If misunderstandings arise, able to patiently clarify message. | Shares ideas fluently in both written and verbal form. Comfortable speaking within team and can clearly explain and strongly advocate for ideas. | As a perceptive communicator, able to use all forms and styles of communication to disambiguate complex messages and ideas to a broad audience. A great listener, they are able to help others communicate and clarify their ideas in group settings. Able to drive agreement in most discussions even when different views are presented. |
| **Design** | Able to think about the performance and reliability of the running code, and offer input into the infrastructure requirements to operate the feature. | Understands how to stand-up common infrastructure components, including VMs and databases, and to consider the performance and requirements for these relative to the code being deployed. Able to document, explain, and discuss the strengths and weaknesses of different architectures considered. | Experienced in full-stack systems and is able to offer perceptive and critical feedback in how to build, scale, and operate highly-available systems. Provides architectural and design guidance when solutions are not well-defined. |
